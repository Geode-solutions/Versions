...
export interface PaginateInterface {
  ...
  <R extends OctokitTypes.RequestInterface, M extends unknown[]>(
    request: R,
    mapFn: MapFunction<NormalizeResponse<OctokitTypes.GetResponseTypeFromEndpointMethod<R>>, M>,
  ): Promise<M>;
  /**
  ...
  <R extends OctokitTypes.RequestInterface>(
    request: R,
    parameters?: Parameters<R>[0],
  ): Promise<NormalizeResponse<OctokitTypes.GetResponseTypeFromEndpointMethod<R>>["data"]>;
  iterator: {
    /**
    ...
    <R extends keyof PaginatingEndpoints>(
      route: R,
      parameters?: PaginatingEndpoints[R]["parameters"],
    ): AsyncIterable<OctokitTypes.OctokitResponse<DataType<PaginatingEndpoints[R]["response"]>>>;
    /**
    ...
    <R extends OctokitTypes.RequestInterface>(
      request: R,
      parameters?: Parameters<R>[0],
    ): AsyncIterable<NormalizeResponse<OctokitTypes.GetResponseTypeFromEndpointMethod<R>>>;
  };
}
